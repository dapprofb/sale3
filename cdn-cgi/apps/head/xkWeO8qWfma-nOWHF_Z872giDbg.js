;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="e89fcdff51150d8974a8b6259869d60e";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["dDVkusI0ClPF"]={appId:"nt4L5NPJq1za",scope:{}};;CloudflareApps.installs["dDVkusI0ClPF"].options={"blocks":[]};;CloudflareApps.installs["K9shzfvEP9bt"]={appId:"0VJ1mCYqPTh4",scope:{}};;CloudflareApps.installs["K9shzfvEP9bt"].options={"color":{"custom":"#666666","strategy":"automatic"},"position":{"value":"bottom-left"},"shape":{"icon":"fancy","radius":0.16,"showBackground":true}};;CloudflareApps.installs["SQ5okqBP0ZAf"]={appId:"nGAnsTeiPCQx",scope:{}};;CloudflareApps.installs["SQ5okqBP0ZAf"].options={"subdomain_tracker_ids":[{"subdomain":"","tracker_id":""}],"tracker_id":"UA-183090-1"};;CloudflareApps.installs["SQ5okqBP0ZAf"].product={"id":"google-analytics-free"};;if(CloudflareApps.matchPage(CloudflareApps.installs['dDVkusI0ClPF'].URLPatterns)){(function(){'use strict'
if(!document.addEventListener)return
var options=CloudflareApps.installs['dDVkusI0ClPF'].options
var elements={}
var prevElements={}
...
window.CloudflareApps.installs['dDVkusI0ClPF'].scope={setOptions:function(nextOptions){options=nextOptions
updateElements()}}}())}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/URH8fY_LFiAmRoN4NMkdyTEjLbc.js';document.head.appendChild(script);})();